...
class NotesService {
  ...
  Future<DatabaseNote> updateNote({
    ...
    final updatesCount = await db.update(noteTable, {
      textColumn: text,
      isSyncedWithCloudCloudColumn: 0,
    });
  ...
  Future<DatabaseNote> createNote({required DatabaseUser owner}) async {
    ...
    final noteId = await db.insert(noteTable, {
      ...
      textColumn: text,
      isSyncedWithCloudCloudColumn: 1,
    });
  ...
  Future<void> _deleteUser({required String email}) async {
    final db = _getDatabaseOrThrow();
...
class DatabaseNote {
  ...
  DatabaseNote.fromRow(Map<String, Object?> map)
    : id = map[idColumn] as int,
      ...
      isSyncedWithCloud = (map[isSyncedWithCloudCloudColumn] as int) == 1
          ? true
          : false;
...
const isSyncedWithCloudCloudColumn = 'is_synced_with_cloud';
